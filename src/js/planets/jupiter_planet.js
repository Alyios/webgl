...
export class Planet_jupiter
{
    ...
    {
        this.globe = {}
        this.globe.geometry = new THREE.SphereBufferGeometry(1.7, 45, 45)
    ...
    {
        this.clouds = {}
        this.clouds.geometry = new THREE.SphereBufferGeometry(1.71, 45, 45)
    ...
    setBelt()
    {
        ...
        for(let i = 0; i < 10000; i++)
        {
            ...
            const distance = 1.85 + Math.random() * 0.7
        ...
        this.belt.material = new THREE.MeshBasicMaterial()
    ...
    setAnimation()
    {
        const loop = () =>
        {
            ...
            this.belt.points.rotation.y += 0.002
        }
        loop()
    }
}
